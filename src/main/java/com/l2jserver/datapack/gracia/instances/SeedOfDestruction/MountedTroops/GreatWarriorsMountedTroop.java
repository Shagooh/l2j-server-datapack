...
public final class GreatWarriorsMountedTroop extends AbstractInstance {
    protected class GreatWarriorsMountedTroopWorld extends InstanceWorld {
    ...
    public void onEnterInstance(L2PcInstance player, InstanceWorld world, boolean firstEntrance) {
        if (firstEntrance) {
            final L2Party party = player.getParty();
            GreatWarriorsMountedTroopWorld _world = (GreatWarriorsMountedTroopWorld) world;
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        if (checkConditions(player)) {
            enterInstance(player, new GreatWarriorsMountedTroopWorld(), "GreatWarriorsMountedTroop.xml", TEMPLATE_ID);
