...
public final class ChamblainsMountedTroop extends AbstractInstance {
    protected class ChamblainsMountedTroopWorld extends InstanceWorld {
    ...
    public void onEnterInstance(L2PcInstance player, InstanceWorld world, boolean firstEntrance) {
        if (firstEntrance) {
            final L2Party party = player.getParty();
            ChamblainsMountedTroopWorld _world = (ChamblainsMountedTroopWorld) world;
    ...
    public String onTalk(L2Npc npc, L2PcInstance player) {
        if (checkConditions(player)) {
            enterInstance(player, new ChamblainsMountedTroopWorld(), "ChamblainsMountedTroop.xml", TEMPLATE_ID);
